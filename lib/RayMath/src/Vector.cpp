...
void Vector3D::normalize() { *this = this->normalized(); }

Vector3D Vector3D::normalized() const { return *this / this->length(); }
...
void Vector3D::rotateX(double angle) { *this = this->rotatedX(angle); }
...
void Vector3D::rotateY(double angle) { *this = this->rotatedY(angle); }
...
void Vector3D::rotateZ(double angle) { *this = this->rotatedZ(angle); }
